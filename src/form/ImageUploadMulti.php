            ...
            <?php if (!empty($value) && is_array($value)): ?>
                <?php foreach ($value as $key => $item): ?>
                    ...
                    <li id="<?= $name ?>-saved-image<?= $key ?>">
                        ...
                        <a class="btn btn-success btn-up" href="javascript:(function(){$('#<?= $name ?>-saved-image<?= $key ?>').insertBefore($('#<?= $name ?>-saved-image<?= $key ?>').prev());})();"><i class="fa fa-arrow-up fa-fw"></i></a>
                        <a class="btn btn-success btn-down" href="javascript:(function(){$('#<?= $name ?>-saved-image<?= $key ?>').before($('#<?= $name ?>-saved-image<?= $key ?>').next());})();"><i class="fa fa-arrow-down fa-fw"></i></a>
                    </li>
                <?php endforeach; ?>
            <?php endif; ?>
        </ul>
